...
Import "native/simd.experimental.js"

Extern 
Class @Float32x4 Extends Object="SIMD_Float32x4Wrapper"
End

Class SIMD
	' Float32x4 Factory
	Function MakeFloat32x4:Float32x4(x:Float, y:Float, z:Float, w:Float) = "Float32x4"
	Function MakeFloat32x4Zero:Float32x4() = "Float32x4.splat(0)"
	Function MakeFloat32x4Reverse:Float32x4(x:Float, y:Float, z:Float, w:Float) = "Float32x4"
	Function MakeFloat32x4One:Float32x4(x:Float) = "Float32x4.splat"
	' Float32x4 Set Operations
	Function Set:Void(destination:Float32x4, x:Float, y:Float, z:Float, w:Float) = "Float32x4.replaceLane"
	Function SetZero:Void(destination:Float32x4)
	Function SetOne:Void(destination:Float32x4, x:Float)
	Function SetReverse:Void(destination:Float32x4, x:Float, y:Float, z:Float, w:Float)
	' Float32x4 Load and Store
